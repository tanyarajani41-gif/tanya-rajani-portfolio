      ...
      <section className="hero" id="home">
        ...
        <div className="hero-content">
          ...
          <div className="hero-cta animate-fade-in-delay-2">
            ...
            <a href="https://drive.google.com/drive/folders/1sYHikT4uxV1CFw4H8y-IbuDnb4YQJwqb?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn btn-outline rounded-none border-primary text-primary bg-destructive-foreground focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background text-slate-800 px-0 bg-slate-200 pl-[20px] pt-0 pr-[20px] pb-[2px] border-slate-100 border-0 border-none shadow-none opacity-100">
